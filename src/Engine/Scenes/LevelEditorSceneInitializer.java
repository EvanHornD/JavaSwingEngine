...
public class LevelEditorSceneInitializer extends SceneInitializer {
    ...
    public void init(Scene scene) {
        ...
        Sprite sprite = AssetPool.getSprite("assets\\images\\tetrisBlockBlue.png");
        Text text = new Text()
                       .setText("Thank You!!")
                       .setFontSize(12)
                       .setFontName("Arial");
    ...
    public void loadResources(Scene scene) {
        AssetPool.addSprite(
            new Sprite().setSprite("assets\\images\\tetrisGreyScale2.png")
        );

        AssetPool.addSprite(
            new Sprite().setSprite("assets\\images\\tetrisBlockBlue.png")
        );

        AssetPool.addSprite(
            new Sprite().setSprite("assets\\images\\TetrisGrid.png")
        );
    }
}
